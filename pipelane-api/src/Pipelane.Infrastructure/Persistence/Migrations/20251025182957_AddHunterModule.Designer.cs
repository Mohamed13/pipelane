...
namespace Pipelane.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251025182957_AddHunterModule")]
    partial class AddHunterModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pipelane.Domain.Entities.FailedWebhook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "NextAttemptUtc", "RetryCount")
                        .HasDatabaseName("IX_FailedWebhooks_Tenant_NextAttempt");

                    b.ToTable("FailedWebhooks");
                });
            ...
            modelBuilder.Entity("Pipelane.Domain.Entities.Prospecting.ProspectList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProspectLists");
                });

            modelBuilder.Entity("Pipelane.Domain.Entities.Prospecting.ProspectListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ProspectListId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProspectListId");

                    b.HasIndex("TenantId", "ProspectListId", "ProspectId")
                        .IsUnique()
                        .HasDatabaseName("IX_ProspectListItems_List_Prospect");

                    b.ToTable("ProspectListItems");
                });
            ...
            modelBuilder.Entity("Pipelane.Domain.Entities.Prospecting.ProspectScore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Pipelane.Domain.Entities.RateLimitSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TargetTenantId", "Scope")
                        .IsUnique()
                        .HasDatabaseName("IX_RateLimitSnapshots_Target_Scope");

                    b.ToTable("RateLimitSnapshots");
                });
            ...
            modelBuilder.Entity("Pipelane.Domain.Entities.Prospecting.ProspectListItem", b =>
                {
                    ...
                    b.HasOne("Pipelane.Domain.Entities.Prospecting.ProspectList", "List")
                        .WithMany("Items")
                        .HasForeignKey("ProspectListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pipelane.Domain.Entities.Prospecting.ProspectScore", b =>
                {
                    b.HasOne("Pipelane.Domain.Entities.Prospecting.Prospect", "Prospect")
                        .WithOne("Score")
                        .HasForeignKey("Pipelane.Domain.Entities.Prospecting.ProspectScore", "ProspectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
